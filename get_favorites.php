<?php
	...
	*/
	...
	function selectDatabase($client_id){
		global $conn;
		$query = 'SELECT r.RecipeID as rid, r.Title as t, u.username as username, r.ImagePath as i FROM FavoriteRecipes f, Recipes r, alpha_users u WHERE f.uid=' . $client_id . ' AND f.RecipeID=r.RecipeID AND r.uid=u.uid;';
