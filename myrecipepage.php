...
<body onload="loadMyRecipes()">
    ...
    <h1>My Recipes</h1>
    <div id="ownRecipePageFeed">
		<div id="myRecipePageFeed" class="feedPagedisplayRecipe">
		</div>
	</div>
    <script type="text/javascript" src="../myrecipes.js"></script>
</body>
</html>